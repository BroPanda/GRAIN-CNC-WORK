...
/**
 * Вкладки з лічильниками непрочитаних. Горизонтальна прокрутка — вкладок
 * вісім, у рядок на телефоні вони не влазять.
 */
export default function NotificationTabs({ active, counts }: Props) {
  return (
    // на телефоні — прокрутка вбік, на ширшому екрані переносимо рядком нижче,
    // щоб «Файли» й «Інше» не ховались за краєм
